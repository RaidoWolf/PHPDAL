    ...
    public function __construct (
        ...
        if (isset($name)) {
            ...
            if (gettype($name) != 'string') {
                ...
                throw new PostgreSQLException(
                    ...
                    PostgreSQLException::EXCEPTION_INPUT_INVALID_TYPE
                );
            }
        } else {
            ...
            throw new PostgreSQLException(
                ...
                PostgreSQLException::EXCEPTION_MISSING_REQUIRED_ARGUMENT
            );
        }
            ...
            if (gettype($host) == 'string') {
                ...
                if (!DatabaseTools::isValidHost($host)) {
                    ...
                    throw new PostgreSQLException(
                        ...
                        PostgreSQLException::EXCEPTION_INPUT_NOT_VALID
                    );
                }
            } else {
        ...
        if ($type == self::TYPE_MYSQL) {
            ...
            throw new PostgreSQLException(
                ...
                PostgreSQLException::EXCEPTION_INVALID_DATABASE_TYPE
            );
        }
        ...
        try {
            ...
            throw new PostgreSQLException(
                ...
                PostgreSQLException::EXCEPTION_GENERIC_DATABASE_ERROR,
                $e
            );
        }
        ...
        if ($table == null) {
            if ($this->hasDefaultTable()) {
                ...
                throw new PostgreSQLException(
                    ...
                    PostgreSQLException::EXCEPTION_MISSING_DEFINITION
                );
            }
        } else {
        ...
        if ($typeof_in == 'array') {
            ...
            if ($depth == 1) {
                ...
                throw new PostgreSQLException(
                    ...
                    PostgreSQLException::EXCEPTION_INPUT_ARRAY_TOO_DEEP
                );
            }
        } else {
            throw new PostgreSQLException(
            ...
            for ($i = 0; $i < $columnCount; $i++) {
                if (!$this->columnExists($column)) {
                    ...
                    throw new PostgreSQLException(
                        ...
                        PostgreSQLException::EXCEPTION_DB_ITEM_DOES_NOT_EXIST
                    );
                }
            }
